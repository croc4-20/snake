'use strict'; // You can keep this for stricter syntax

import { Server } from 'socket.io'; // Replace require with import
import * as config from '../web/common/config.js'; // Use explicit .js extension
import * as utils from '../web/common/utils.js'; // Use explicit .js extension
